...
public class Player_Movement : MonoBehaviour
{
    ...
    public bool alwaysRun = true; // if true always runs and if c presses walks, else otherway around.
    public bool MouseCST = true; // if true lets you hold for the wall with right mouse else with pressing left ctrl
    ...
    void Update()
    {
        ...
        // Checks all his hit boxes
        CheckHitBoxes();
        
        // chaeck if player moving
        MoveUpdate();
        
        // if player stands on the ground
